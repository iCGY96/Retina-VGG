...
#  COCO       - COCO api class that loads COCO annotation file and prepares data structures.
...
class COCO:
    ...
    def showAnns(self, anns):
        ...
        if self.dataset['type'] == 'instances':
            ...
            p = PatchCollection(polygons, facecolors=colors, edgecolors=(0, 0, 0, 1), linewidths=3, alpha=0.4)
            ax.add_collection(p)
